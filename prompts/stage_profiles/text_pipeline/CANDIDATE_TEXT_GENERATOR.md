...
Для `FAIRY_TALE + RUSSIAN_FOLK_TALE + лиса`, если пользователь не просил конкретную сказку, **сначала заполняй пул основными источниками** из `FAIRY_TALE_ANIMAL_FOX`: волк, журавль, медведь, скалочка, петушок, тетерев и т.п. Избушка и колобок в fox entity layer — это эталоны техники (как сохранять причинность), а не default-сюжеты. Пиши каждый candidate как маленькую сцену, а не как список шагов: место, одна реплика, одна проказа, реакция и смешной выход. В одном пуле достаточно не более одной избушки и не более одного колобка.

Для fox `NARRATIVE` не закрывай весь пул одинаковым финалом «засмеялась и убежала». Разнообразь комичные развязки между candidates: догонялка, комичный промах, громкий звук, раскрытая проказа, переворот ожидания или безобидный проигрыш лисы.

Не используй смех как обязательную финальную эмоцию. В большинстве fox candidates финал должен завершаться конкретным действием или последствием: лиса юркнула за куст, осталась с пустой лапкой, отскочила от крика, добыча упала, птица взлетела выше, другой персонаж ахнул.
...
Допустимо: для `FAIRY_TALE + RUSSIAN_FOLK_TALE + лиса` — взять основной источник из `FAIRY_TALE_ANIMAL_FOX`, например волк/рыбка, журавль/кувшин, медведь/ягоды, скалочка, петушок или тетерев, и написать короткую сцену с местом, репликой, проказой, реакцией и смешным выходом.
...
Недопустимо: для `FAIRY_TALE + RUSSIAN_FOLK_TALE + лиса` взять полные эталоны избушки/колобка как шаблон для большинства candidates вместо основных fox-источников из entity layer.

Недопустимо: для fox `NARRATIVE` завершить большинство candidates одной и той же эмоцией — «засмеялась», «расхохоталась», «усмехнулся», «со смехом убежала».
