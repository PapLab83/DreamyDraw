...
Допустимо: для `FAIRY_TALE + RUSSIAN_FOLK_TALE + лиса` — эпизод избушки или колобка с полной причинностью (просьба → хитрость → реакция → поворот); см. эталоны в `FAIRY_TALE_ANIMAL_FOX`, блок «Народные эпизоды с лисой».
