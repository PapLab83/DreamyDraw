...
Используй этот слой, когда результат должен быть короткой детской историей или рассказом. Слой задаёт форму результата и базовые ожидания к candidate text, но не решает, будет ли мир правдивым, сказочным или мифологическим.
