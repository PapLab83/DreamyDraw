...
**[mock] LLMMockProvider — один ответ на любой промпт**
...
**[trace] Langfuse: лишний `_update_trace_metadata` в Orchestrator**
...
**[restore] Resume сессии через `--session` неэффективен**
...
**[cli] Presentation layer: `print` смешан с main**
...
**[parser] `parse_llm_json` не снимает markdown-обёртку**
